...
function SideBar() {
  ...
  const [selectedOption, setSelectedOption] = useState("Dashbord");
  ...
  return (
    <div className=" shadow-sm h-screen ">
      <div className="logo ml-4  pb-10 flex items-center mt-8 text-sm ">
      ...
      <div className="options ">
        <div className="flex flex-col gap-y-4 ml-10 justify-center">
          ...
          >
            <div
              className={` ${
                selectedOption === "Dashbord" ? "bg-DarkBlue" : "bg-white"
              } p-1 rounded-lg w-6`}
            >
              <svg
                width="15"
              ...
              >
                <g clipPath="url(#clip0_4_1854)">
                  <path
                    ...
                    fill={` ${
                      selectedOption === "Dashbord" ? "white" : "#313860"
                    }`}
                  />
                  <path
